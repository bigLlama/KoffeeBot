...
class images(commands.Cog):
    ...
    @app_commands.describe(member="The user you wish to be shipped with")
    ...
    async def ship(self, interaction: discord.Interaction, member: discord.Member):
        ...
        await interaction.followup.send(
            f"The probability of you shipping with {member} is **{random_number}%**")
    ...
    @app_commands.checks.cooldown(1, 5.0, key=lambda i: (i.guild_id, i.user.id))
    @app_commands.describe(member="The user you wish to punch")
    ...
    @app_commands.checks.cooldown(1, 5.0, key=lambda i: (i.guild_id, i.user.id))
    @app_commands.describe(member="The user you wish to slap")
    ...
    @app_commands.checks.cooldown(1, 5.0, key=lambda i: (i.guild_id, i.user.id))
    @app_commands.describe(member="The user you wish to threaten")
    async def blackmail(self, interaction: discord.Interaction, member: discord.Member):
